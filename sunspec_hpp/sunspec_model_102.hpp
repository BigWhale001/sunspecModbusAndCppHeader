// Generated C++ Header for Model 102
#pragma once
...
class Model102 : public SunSpecModelBase {
public:
    static constexpr uint16_t ID = 102;
    Model102_Raw raw;
    ...
    void from_buffer(const uint8_t* buffer) override {
        base_addr = buffer;
        std::memcpy(&raw, buffer, sizeof(Model102_Raw));
    }
    ...
    void print_attributes() const override {
        ...
        const uint8_t* cur_ptr = base_addr + sizeof(Model102_Raw);
    }
