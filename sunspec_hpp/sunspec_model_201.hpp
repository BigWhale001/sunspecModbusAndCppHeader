// Generated C++ Header for Model 201
#pragma once
...
class Model201 : public SunSpecModelBase {
public:
    static constexpr uint16_t ID = 201;
    Model201_Raw raw;
    ...
    void from_buffer(const uint8_t* buffer) override {
        base_addr = buffer;
        std::memcpy(&raw, buffer, sizeof(Model201_Raw));
    }
    ...
    float get_PPVphAB() const {
        int16_t sf_val = be16toh_custom_s(raw.V_SF);
        if (sf_val == (int16_t)0x8000) return NAN;
        int16_t val = be16toh_custom_s(raw.PPVphAB);
        return (float)val * std::pow(10.0f, sf_val);
    }

    int16_t get_raw_PPVphAB() const {
        return be16toh_custom_s(raw.PPVphAB);
    }

    float get_PPVphBC() const {
        int16_t sf_val = be16toh_custom_s(raw.V_SF);
        if (sf_val == (int16_t)0x8000) return NAN;
        int16_t val = be16toh_custom_s(raw.PPVphBC);
        return (float)val * std::pow(10.0f, sf_val);
    }

    int16_t get_raw_PPVphBC() const {
        return be16toh_custom_s(raw.PPVphBC);
    }

    float get_PPVphCA() const {
        int16_t sf_val = be16toh_custom_s(raw.V_SF);
        if (sf_val == (int16_t)0x8000) return NAN;
        int16_t val = be16toh_custom_s(raw.PPVphCA);
        return (float)val * std::pow(10.0f, sf_val);
    }

    int16_t get_raw_PPVphCA() const {
        return be16toh_custom_s(raw.PPVphCA);
    }
    ...
    void print_attributes() const override {
        ...
        std::cout << "    L: " << get_raw_L() << std::endl;
            ...
            std::cout << "    PPVphAB: " << be16toh_custom_s(raw.PPVphAB) << std::endl;
            std::cout << "    PPVphBC: " << be16toh_custom_s(raw.PPVphBC) << std::endl;
            std::cout << "    PPVphCA: " << be16toh_custom_s(raw.PPVphCA) << std::endl;
        ...
        const uint8_t* cur_ptr = base_addr + sizeof(Model201_Raw);
    }
