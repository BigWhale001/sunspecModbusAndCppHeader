// Generated C++ Header for Model 103
#pragma once
...
class Model103 : public SunSpecModelBase {
public:
    static constexpr uint16_t ID = 103;
    Model103_Raw raw;
    ...
    void from_buffer(const uint8_t* buffer) override {
        base_addr = buffer;
        std::memcpy(&raw, buffer, sizeof(Model103_Raw));
    }
    ...
    void print_attributes() const override {
        ...
        const uint8_t* cur_ptr = base_addr + sizeof(Model103_Raw);
    }
