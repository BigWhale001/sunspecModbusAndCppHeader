...
public:
    ...
    void print_attributes() const override {
        ...
        std::cout << "    VRef: " << be16toh_custom(raw.VRef) << std::endl;
        std::cout << "    VRefOfs: " << be16toh_custom_s(raw.VRefOfs) << std::endl;
        ...
        std::cout << "    VArMaxQ1: " << be16toh_custom_s(raw.VArMaxQ1) << std::endl;
        std::cout << "    VArMaxQ2: " << be16toh_custom_s(raw.VArMaxQ2) << std::endl;
        std::cout << "    VArMaxQ3: " << be16toh_custom_s(raw.VArMaxQ3) << std::endl;
        std::cout << "    VArMaxQ4: " << be16toh_custom_s(raw.VArMaxQ4) << std::endl;
        std::cout << "    WGra: " << be16toh_custom(raw.WGra) << std::endl;
        std::cout << "    PFMinQ1: " << be16toh_custom_s(raw.PFMinQ1) << std::endl;
        std::cout << "    PFMinQ2: " << be16toh_custom_s(raw.PFMinQ2) << std::endl;
        std::cout << "    PFMinQ3: " << be16toh_custom_s(raw.PFMinQ3) << std::endl;
        std::cout << "    PFMinQ4: " << be16toh_custom_s(raw.PFMinQ4) << std::endl;
        std::cout << "    VArAct: " << be16toh_custom(raw.VArAct) << std::endl;
        std::cout << "    ClcTotVA: " << be16toh_custom(raw.ClcTotVA) << std::endl;
        std::cout << "    MaxRmpRte: " << be16toh_custom(raw.MaxRmpRte) << std::endl;
        std::cout << "    ECPNomHz: " << be16toh_custom(raw.ECPNomHz) << std::endl;
        std::cout << "    ConnPh: " << be16toh_custom(raw.ConnPh) << std::endl;
        std::cout << "    WMax_SF: " << be16toh_custom_s(raw.WMax_SF) << std::endl;
        std::cout << "    VRef_SF: " << be16toh_custom_s(raw.VRef_SF) << std::endl;
        std::cout << "    VRefOfs_SF: " << be16toh_custom_s(raw.VRefOfs_SF) << std::endl;
        std::cout << "    VMinMax_SF: " << be16toh_custom_s(raw.VMinMax_SF) << std::endl;
        std::cout << "    VAMax_SF: " << be16toh_custom_s(raw.VAMax_SF) << std::endl;
        std::cout << "    VArMax_SF: " << be16toh_custom_s(raw.VArMax_SF) << std::endl;
        std::cout << "    WGra_SF: " << be16toh_custom_s(raw.WGra_SF) << std::endl;
        std::cout << "    PFMin_SF: " << be16toh_custom_s(raw.PFMin_SF) << std::endl;
        std::cout << "    MaxRmpRte_SF: " << be16toh_custom_s(raw.MaxRmpRte_SF) << std::endl;
        std::cout << "    ECPNomHz_SF: " << be16toh_custom_s(raw.ECPNomHz_SF) << std::endl;
    }
