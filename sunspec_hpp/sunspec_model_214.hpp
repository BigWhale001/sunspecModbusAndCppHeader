// Generated C++ Header for Model 214
#pragma once
...
class Model214 : public SunSpecModelBase {
public:
    static constexpr uint16_t ID = 214;
    Model214_Raw raw;
    ...
    void from_buffer(const uint8_t* buffer) override {
        base_addr = buffer;
        std::memcpy(&raw, buffer, sizeof(Model214_Raw));
    }
    ...
    void print_attributes() const override {
        ...
        const uint8_t* cur_ptr = base_addr + sizeof(Model214_Raw);
    }
