// Generated C++ Header for Model 203
#pragma once
...
class Model203 : public SunSpecModelBase {
public:
    static constexpr uint16_t ID = 203;
    Model203_Raw raw;
    ...
    void from_buffer(const uint8_t* buffer) override {
        base_addr = buffer;
        std::memcpy(&raw, buffer, sizeof(Model203_Raw));
    }
    ...
    void print_attributes() const override {
        ...
        const uint8_t* cur_ptr = base_addr + sizeof(Model203_Raw);
    }
