// Generated C++ Header for Model 213
#pragma once
...
class Model213 : public SunSpecModelBase {
public:
    static constexpr uint16_t ID = 213;
    Model213_Raw raw;
    ...
    void from_buffer(const uint8_t* buffer) override {
        base_addr = buffer;
        std::memcpy(&raw, buffer, sizeof(Model213_Raw));
    }
    ...
    void print_attributes() const override {
        ...
        const uint8_t* cur_ptr = base_addr + sizeof(Model213_Raw);
    }
